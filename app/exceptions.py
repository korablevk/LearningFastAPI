...
class NotExistBooking(BookingException):
...
class WrongDateForm(BookingException):
    status_code = status.HTTP_400_BAD_REQUEST
    detail = "Невозможное значение дат"


class DaysOutOfLimit(BookingException):
    status_code = status.HTTP_400_BAD_REQUEST
    detail = "Невозможно забранировать номер больше чем на 30 дней"